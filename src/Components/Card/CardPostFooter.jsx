...
export default function CardPostFooter({commentsNumber , postId}) {
  return <>
      ...
      <div className="w-full flex justify-between">
        <p className="ml-3 text-gray-500">30</p>
        <p className="ml-3 text-gray-500"><Link to={'post-details/'+postId}>{commentsNumber} comment</Link></p>
      </div>
    </div>
    
    <div className="grid grid-cols-3 w-full px-5  my-3 border-t border-divider pt-3 ">
      ...
      <button className="flex flex-row justify-center items-center w-full space-x-3"><svg xmlns="http://www.w3.org/2000/svg" width={27} height={27} viewBox="0 0 24 24" fill="none" stroke="#838383" strokeWidth={2} strokeLinecap="square" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
        <span className="font-semibold text-lg text-gray-600">Comments</span></button>
